# BearishTaUsdcWethBaseStrategy - Agent Guide

> AI coding agent context for the `bearish_ta_usdc_weth_base` strategy.

## Overview

- **Template:** ta_swap
- **Chain:** base
- **Class:** `BearishTaUsdcWethBaseStrategy` in `strategy.py`
- **Config:** `config.json`
